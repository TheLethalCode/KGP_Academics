...
$sql = "SELECT  tblevents.id as eid,tblevents.EventName,tblevents.EventStartDate,tblevents.EventEndDate,tblcategory.CategoryName from tblevents join tblcategory on tblcategory.id=tblevents.CategoryId where tblevents.Created_id=:created_id";
