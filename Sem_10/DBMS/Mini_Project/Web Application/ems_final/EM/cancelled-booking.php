...
<head>
    ...
    <title>EMS | Manage User Bookings</title>
...
$sql = "SELECT tblbookings.id as bid,tblbookings.BookingId,tblevents.Created_id,tblevents.EventName,tblusers.FullName,tblbookings.NumberOfMembers,tblbookings.BookingStatus,tblbookings.BookingDate from tblbookings left  join tblusers on tblusers.Userid=tblbookings.UserId left join tblevents on tblevents.id=tblbookings.EventId where tblbookings.BookingStatus=:status and tblevents.Created_id=:created_id";
