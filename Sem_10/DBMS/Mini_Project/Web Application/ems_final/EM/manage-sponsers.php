...
$sql = "SELECT id,sponserName,sponserLogo,postingDate from tblsponsers Where Created_id = :created_id";
$query = $dbh -> prepare($sql);
...
<td><img src="sponsers/<?php echo htmlentities($row->sponserLogo);?>" width="250" height="200" /></td>
