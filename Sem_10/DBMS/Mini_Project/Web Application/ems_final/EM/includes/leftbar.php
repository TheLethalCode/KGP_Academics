                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="all-categories.php">View All</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
   <li>
                        ...
                        <li>
                            <a href="available-rooms.php"><i class="fa fa-files-o"></i> Available Rooms</a>
                        </li>
...
<li>
                            <a href="logout.php"><i class="fa fa-files-o"></i> Logout</a>
                        </li>
