...
$sql ="SELECT RAid,UserName,Password FROM room_authority WHERE UserName=:username and Password=:password";
...
echo "<script type='text/javascript'> document.location ='authorize_event.php'; </script>";
} else{
    // For invalid details
...
<html lang="en">
<head>
    <title>Event Management System | Room Authority login </title>
...
<h3>Event Management System  | Room Authority</h3>
</div>
