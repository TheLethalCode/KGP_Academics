...
$sql="INSERT INTO room_authority(FullName,UserName,Emailid,PhoneNumber,Gender,Password,IsActive) VALUES(:fname,:uname,:emailid,:pnumber,:gender,:password,:status)";
//preparing the query
...
else 
{
                ...
                else
                {
                    ...
                    mysqli_query($conn,"INSERT INTO `room_authority` ( `FullName`, `UserName`, `Emailid`, `PhoneNumber`, `Gender` ,`Password`,`IsActive`) VALUES ('$fname','$uname','$emailid','$pnumber','$gender','$password','$status')"
                       ...
                       <div class="col-md-8 col-sm-7">
                           <div class="single-blog-body">
                                ...
                                <div class="Leave-your-thought mt50">
                                    <h3 class="aside-title uppercase">Room_Authority Signup</h3>
                                    <div class="row">
