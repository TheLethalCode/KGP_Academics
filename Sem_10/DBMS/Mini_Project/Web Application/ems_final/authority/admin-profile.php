...
<!--?php include_once('includes/leftbar.php');?-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Authority Profile</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php
$aid=$_SESSION['adminsession'];
$sql ="SELECT FullName,Email,Service,UserName FROM booking_authority where id=:aid";
...
<input class="form-control" type="text" value="<?php echo htmlentities($row->FullName);?>" name="fullname" autocomplete="off" readonly>
</div>

<div class="form-group">
<label>Email-Id</label>
<input class="form-control" type="email" value="<?php echo htmlentities($row->Email);?>"  name="adminemail" autocomplete="off" readonly />
</div>
